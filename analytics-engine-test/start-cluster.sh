...
exec env JAVA_HOME="$JAVA25" ./gradlew run \
  ...
  -PinstalledPlugins="['opensearch-job-scheduler','arrow-base','arrow-flight-rpc','composite-engine','parquet-data-format','analytics-engine','analytics-backend-datafusion','analytics-backend-lucene','opensearch-sql-plugin:3.7.0.0-SNAPSHOT']"
