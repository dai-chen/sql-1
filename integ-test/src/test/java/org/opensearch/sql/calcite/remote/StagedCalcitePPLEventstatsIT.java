 ...
 */
@Ignore(
    "US-010 baseline: 26/27 fail under the staged posture (CannotPlanException, no ENUMERABLE"
        + " conversion rules for the window plan). Unblocked by US-015 and the CONCAT path.")
