...
/**
 * Runs all CalciteFieldsCommandIT tests through the staged execution path by disabling pushdown and
 ...
 */
public class StagedCalciteFieldsCommandIT extends CalciteFieldsCommandIT {
