...
public abstract class CalciteAbstractTest {
  ...
  public CalciteAbstractTest(CalciteAssert.SchemaSpec... schemaSpecs) {
  ...
  private Node plan(PPLSyntaxParser parser, String query) {
    doReturn(true).when(settings).getSettingValue(Key.CALCITE_ENGINE_ENABLED);
  ...
  protected void verifyResult(RelNode rel, String expectedResult) {
