...
public class UnifiedQueryPlannerTest extends UnifiedQueryTestBase {
  ...
  /** Test catalog with nested schema structure for multi-level namespace tests */
  private AbstractSchema testDeepSchema;

  @Before
  public void setUp() {
    super.setUp();

    // Create deep schema for multi-level namespace tests
    testDeepSchema =
        new AbstractSchema() {
          @Override
